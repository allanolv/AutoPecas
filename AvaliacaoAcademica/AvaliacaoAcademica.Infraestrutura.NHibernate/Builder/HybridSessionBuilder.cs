...
namespace AvaliacaoAcademica.Infraestrutura.NHibernate.Builder
{
    public class HybridSessionBuilder
    {
        ...
        public static FluentConfiguration Build()
        {
            return Fluently.Configure()
                           .Database(MsSqlConfiguration.MsSql2008.ConnectionString(c => c.FromAppSetting("SistemaAvaliacao")))
